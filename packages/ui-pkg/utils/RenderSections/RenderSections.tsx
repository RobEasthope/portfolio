...
const LandingHero = dynamic(
  () => import('ui-pkg/sections/LandingHero/LandingHero')
);
...
const ProjectIndex = dynamic(
  () => import('ui-pkg/sections/ProjectIndex/ProjectIndex')
);
...
const VimeoVideo = dynamic(
  () => import('ui-pkg/sections/VimeoVideo/VimeoVideo')
);
const YoutubeVideo = dynamic(
  () => import('ui-pkg/sections/YoutubeVideo/YoutubeVideo')
);
